...
function changeElementPrompt() {
	var cmToElement = promptTxt("Enter what you want to change pixels to");
...
function updateChangeDescriptions() {
	elements.change.desc = "Changes any pixels it is used on to a specified type.<br/>Currently replacing pixels with \"" + changeTo + "\".<br/><span onclick=changeElementPrompt() style=\"color: #ffffff;\";>Press [ü] or click here</span> to open the change prompt.";
	elements.alt_change.desc = "Changes any pixels it is used on to a specified type, but keeping their non-element-based properties.<br/>Currently replacing pixels with \"" + changeTo + "\".<br/><span onclick=changeElementPrompt() style=\"color: #ffffff;\";>Press [ü] or click here</span> to open the change prompt.";
...
elements.change = {
    ...
    category: "edit",
	desc: "Changes any pixels it is used on to a specified type.<br/>Currently replacing pixels with \"" + changeTo + "\".<br/><span onclick=changeElementPrompt() style=\"color: #ffffff;\";>Press [ü] or click here</span> to open the change prompt.",
};
...
elements.alt_alt_change = {
    ...
    category: "edit",
	desc: "Changes any pixels it is used on to a specified type, but keeping their non-element-based properties except for color.<br/>Currently replacing pixels with \"" + changeTo + "\".<br/><span onclick=changeElementPrompt() style=\"color: #ffffff;\";>Press [ü] or click here</span> to open the change prompt.",
	hidden: true,
};changeTo = "sand";
